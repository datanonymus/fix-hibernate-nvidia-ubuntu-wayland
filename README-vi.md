...
Hiện tại, bản Kernel `7.0.0` mặc định của Ubuntu 26.04 (cài từ file ISO sạch) đang xung đột nặng với driver NVIDIA Proprietary. Khi thực hiện Hibernate, máy sẽ chớp đen 2 giây rồi **đóng băng vĩnh viễn ở màn hình khóa**, buộc người dùng phải đè nút nguồn để tắt nóng. Để giải pháp này hoạt động, bạn **BẮT BUỘC phải lùi về Kernel 6.8.x**.
